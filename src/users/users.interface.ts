...
import { Bank } from 'src/common/bank/bank.interface';
import { Company } from 'src/common/company/company.interface';
import { Hair } from 'src/common/hair/hair.interface';
